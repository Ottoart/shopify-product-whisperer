...
-- Clean up any ProductWhisper related data from remaining tables (using correct column name)
DELETE FROM public.marketplace_sync_status WHERE marketplace LIKE '%productwhisper%' OR marketplace LIKE '%product-whisper%';
