...
-- 4. Create sample products for testing using correct column structure
...
(
  ...
  true,
  true,
  'Sample hair care product for testing shipping and order management',
  'Shopify',
  'active',
  100,
  now(),
...
(
  ...
  true,
  true,
  'Another sample hair care product for comprehensive testing',
  'Shopify',
  'active',
  50,
  now(),
...
-- 6. Create marketplace sync status for test account with correct sync_status value
