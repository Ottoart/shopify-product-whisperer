  ...
  
{
  ...
  "category": "REQUIRED: Select appropriate Shopify standard category. HAIR CARE PRODUCTS use: 'Health & Beauty > Personal Care > Cosmetics > Hair Care > [specific subcategory like Hair Shampoo & Conditioner, Hair Styling Products, Hair Treatments & Masks, Hair Coloring Products]'. NAIL CARE PRODUCTS use: 'Health & Beauty > Personal Care > Cosmetics > Nail Care > [specific like Nail Polish, Nail Care Tools, Nail Treatments]'. SKINCARE use: 'Health & Beauty > Personal Care > Cosmetics > Skin Care > [specific like Face Moisturizers, Face Cleansers, Face Serums & Treatments]'. Choose the MOST SPECIFIC category that matches the product exactly.",
